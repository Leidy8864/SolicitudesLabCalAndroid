package pe.leidy_cs.solicitudeslabcalandroid.activities;
...
import pe.leidy_cs.solicitudeslabcalandroid.services.ApiServiceGenerator;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipoSpinner = (Spinner)findViewById(R.id.tipo_input);
    ...
    public void callRegister(View view) {
        ...
        if (motivo.isEmpty() || correo.isEmpty() || tipoText.isEmpty()) {
            Toast.makeText(this, "Son campos requeridos", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createSolicitud(correo, tipoText, motivo);
        } else {
            ...
            RequestBody tipoPart = RequestBody.create(MultipartBody.FORM, tipoText);
